...
class Yolov7Publisher:
    def __init__(self, image1: str, weights: str, conf_thresh: float = 0.5,
        ...
        vis_topic = pub_topic + "visualization_delivery" if pub_topic.endswith("/") else \
            pub_topic + "/visualization_delivery"
        ...
        self.img_subscriber = rospy.Subscriber(
            image1, Image, self.process_img_msg
        )
...
################################################################################################################
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        if self.visualization_publisher:
            ...
            biggest_delivery =right_delivery
            ...
            if right_delivery[0][0] == biggest_delivery[0][0]:
                ...
                # print(delivery_sign)
            elif right_delivery[0][1] >= biggest_delivery[0][1]:
...
if __name__ == "__main__":
    ...
    image1 = rospy.get_param(ns + "image1")
